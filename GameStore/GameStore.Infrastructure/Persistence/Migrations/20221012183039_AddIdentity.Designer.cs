...
namespace GameStore.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20221012183039_AddIdentity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GameStore.Infrastructure.Services.Identity.Entities.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("GameStore.Infrastructure.Services.Identity.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("GameStore.Infrastructure.Services.Identity.Entities.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("GameStore.Infrastructure.Services.Identity.Entities.User", null)
                        .WithMany()
